...
- Wave 0: Contract Freeze / Scaffold - Scaffold the two minimal TypeScript contract files for fresh ACPX mission execution proof

## Active Packets

- fresh-acpx-001: Scaffold mission_types.ts contract file
- fresh-acpx-002: Scaffold artifact_types.ts contract file
