...
- Wave 0: Contract Freeze / Scaffold - Scaffold minimal TypeScript contract files for fresh ACPX mission execution

## Active Packets

- acpx-fresh-0-001: Scaffold mission_types.ts contract
- acpx-fresh-0-002: Scaffold artifact_types.ts contract
