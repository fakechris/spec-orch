...
- Wave 0: Contract Freeze / Scaffold - Create minimal TypeScript contract files to enable fresh ACPX mission execution

## Active Packets

- acpx-contract-mission-types: Scaffold mission_types.ts contract
- acpx-contract-artifact-types: Scaffold artifact_types.ts contract
