...
- 把 live runtime observability 补成统一的 chain substrate，先解决运行期查询效率，再继续深挖真实 E2E 阻塞
...
### Milestone 1.5: Runtime Chain Observability and Live Traceability

**为什么现在做**：真实 fresh mission / exploratory E2E 暴露了一个新的基础设施缺口。ACPX worker 本身有 telemetry，但 supervisor / acceptance / replay 等长阶段缺少统一 heartbeat 和链路级状态面，导致诊断依赖手工翻日志。这个问题不解决，后续 E2E 稳定性工作会持续低效。
