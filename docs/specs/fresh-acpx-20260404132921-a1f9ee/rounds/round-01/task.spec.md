...
- Wave 0: Contract Freeze / Scaffold - Define TypeScript interfaces for mission and artifact types to establish the fresh execution contract.

## Active Packets

- fresh-acpx-mission-types-scaffold: Scaffold mission_types.ts contract interface
- fresh-acpx-artifact-types-scaffold: Scaffold artifact_types.ts contract interface
