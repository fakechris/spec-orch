...
- Wave 0: Contract Freeze / Scaffold - Create minimal TypeScript contract files for ACPX mission execution proof

## Active Packets

- acpx-contracts-mission-types: Scaffold mission_types.ts contract file
- acpx-contracts-artifact-types: Scaffold artifact_types.ts contract file
