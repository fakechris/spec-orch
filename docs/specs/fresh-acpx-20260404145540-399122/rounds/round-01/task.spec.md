...
- Wave 0: Contract Freeze / Scaffold - Create TypeScript contract files for fresh ACPX mission

## Active Packets

- fresh-acpx-mission-types: Scaffold mission_types.ts contract
- fresh-acpx-artifact-types: Scaffold artifact_types.ts contract
