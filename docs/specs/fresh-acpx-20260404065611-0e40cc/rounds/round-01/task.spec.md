...
- Wave 0: Contract Freeze / Scaffold - Define TypeScript contract interfaces for mission_types and artifact_types

## Active Packets

- acpx-contract-mission-types-scaffold: Scaffold mission_types.ts contract
- acpx-contract-artifact-types-scaffold: Scaffold artifact_types.ts contract
