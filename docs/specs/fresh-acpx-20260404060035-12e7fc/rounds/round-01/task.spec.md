...
- Wave 0: Contract Freeze / Scaffold - Create minimal TypeScript contract files for mission and artifact type definitions

## Active Packets

- acpx-fresh-scaffold-mission-types: Scaffold mission_types.ts contract file
- acpx-fresh-scaffold-artifact-types: Scaffold artifact_types.ts contract file
