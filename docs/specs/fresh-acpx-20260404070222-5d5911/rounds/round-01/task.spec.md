...
- Wave 0: Contract Freeze / Scaffold - Create minimal TypeScript contract files for ACPX mission proof-of-execution

## Active Packets

- acpx-contract-mission-types: Scaffold mission_types.ts contract file
- acpx-contract-artifact-types: Scaffold artifact_types.ts contract file
